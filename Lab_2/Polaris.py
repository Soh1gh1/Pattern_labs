...
class PersonalInfo:
    ...
    first_name (str): Personal first name
    second_name (str): Personal second name
    adress: str
    phone_number: str
    email: str
    position: int
...
class Course:
    ...
    def __init__(self, title: str, start_date: datetime, end_date: datetime, description: str, lectures: list[str],
                 assignments: list[str], limit: int, ):
        self.title = title
...
class Student(Staff):
    ...
    def __init__(self, name: str,
        ...
        self._personal_info = PersonalInfo(None, None, None, None, None, None, None, None, None, None)
...
student1 = Student('Yarish Nazar', 'lviv', '0672699228', 'Soh1gh3105@gmail.com', 12, )
person1 = PersonalInfo(2, None, 'Nazar', 'Yarish', 'lviv', '0672699228', 'HSoh1gh3105@gmail.com', 12, None, None)
course1 = Course('Course', (12, 12, 2022), (12, 12, 2022), None, ['Sub1', 'Sub2', 'Sub3'],
                 ['programming', 'developing games', 'running'], 2)
student_progress_1 = (
{"Sub1": 12, "sub2": 12, "sub3": 12}, 12, {'sub1': True, 'sub2': False, 'sub3': True},
